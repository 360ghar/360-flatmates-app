...
IconData listingIconForOption(String id) {
  return switch (id) {
    ...
    'power_backup' => Icons.electrical_services_outlined,
    'nearby_parks' => Icons.park_outlined,
    'gym' => Icons.fitness_center_outlined,
    'cctv' => Icons.videocam_outlined,
    'intercom' => Icons.speaker_phone_outlined,
    'garden' => Icons.local_florist_outlined,
    'clubhouse' => Icons.meeting_room_outlined,
    'vegetarian' => Icons.eco_outlined,
    'non_vegetarian' => Icons.restaurant_outlined,
    'eggetarian' => Icons.egg_outlined,
    'any' => Icons.all_inclusive_outlined,
    'good' => Icons.air_outlined,
    'average' => Icons.blur_on_outlined,
    'poor' => Icons.cloud_outlined,
