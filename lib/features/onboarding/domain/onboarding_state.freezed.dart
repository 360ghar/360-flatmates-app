...
mixin _$OnboardingState {
  ...
  Map<String, String> get lifestyleAnswers =>
      ...
      _value.copyWith(
            ...
            photoUrls: null == photoUrls
                ...
                : photoUrls // ignore: cast_nullable_to_non_nullable
                      as List<String>,
            lifestyleAnswers: null == lifestyleAnswers
                ? _value.lifestyleAnswers
                : lifestyleAnswers // ignore: cast_nullable_to_non_nullable
            ...
            nonNegotiables: null == nonNegotiables
                ? _value.nonNegotiables
                : nonNegotiables // ignore: cast_nullable_to_non_nullable
                      as List<String>,
...
class _$OnboardingStateImpl extends _OnboardingState {
  const _$OnboardingStateImpl({
    ...
    final Map<String, String> lifestyleAnswers = const {},
    this.budgetMin,
    this.budgetMax,
    this.moveInTimeline,
    ...
    this.error,
       ...
       _nonNegotiables = nonNegotiables,
       super._();
  ...
  @JsonKey()
  Map<String, String> get lifestyleAnswers {
    if (_lifestyleAnswers is EqualUnmodifiableMapView) return _lifestyleAnswers;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_lifestyleAnswers);
  }
  ...
  final List<String> _nonNegotiables;
  @override
  @JsonKey()
  List<String> get nonNegotiables {
    if (_nonNegotiables is EqualUnmodifiableListView) return _nonNegotiables;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_nonNegotiables);
  }
  ...
  int get hashCode => Object.hash(
    ...
    const DeepCollectionEquality().hash(_lifestyleAnswers),
    budgetMin,
    budgetMax,
    moveInTimeline,
